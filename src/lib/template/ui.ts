...
export const UI = {
  fr: {
    ...
    svcLabel: 'Nos prestations', svcTitle: 'Nos Services', svcDesc: 'Des prestations pensées pour répondre à vos besoins avec soin et expertise.', svcLink: 'En savoir plus',
    ...
    procLabel: 'Comment ça marche',     procTitle: 'Notre méthode pas à pas', procDesc: 'Du premier contact à la réalisation, nous vous accompagnons à chaque étape.',
    ...
    ctaTitle: 'Un projet en tête ?', ctaDesc: 'Échangez avec nous dès maintenant, nous répondons sous 2h.',
  ...
  en: {
    ...
    svcLabel: 'What We Do', svcTitle: 'Our Services', svcDesc: 'Services designed to meet your needs with care and expertise.', svcLink: 'Learn more',
    ...
    procLabel: 'How It Works',     procTitle: 'Our Step-by-Step Method', procDesc: 'From first contact to completion, we guide you every step of the way.',
    ...
    ctaTitle: 'Have a project in mind?', ctaDesc: 'Get in touch now — we reply within 2 hours.',
    contactLabel: 'Quote & Booking', contactTitle: 'Get Your Free Quote', contactDesc: 'Send us a message or give us a call. We respond quickly.',
